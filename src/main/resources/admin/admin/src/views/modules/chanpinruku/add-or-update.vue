<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供货厂家" prop="gonghuochangjia">
          <el-input v-model="ruleForm.gonghuochangjia" 
              placeholder="供货厂家" clearable  :readonly="ro.gonghuochangjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供货厂家" prop="gonghuochangjia">
              <el-input v-model="ruleForm.gonghuochangjia" 
                placeholder="供货厂家" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="产品进价" prop="chanpinjinjia">
          <el-input v-model="ruleForm.chanpinjinjia" 
              placeholder="产品进价" clearable  :readonly="ro.chanpinjinjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="产品进价" prop="chanpinjinjia">
              <el-input v-model="ruleForm.chanpinjinjia" 
                placeholder="产品进价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="摆放位置" prop="baifangweizhi">
          <el-input v-model="ruleForm.baifangweizhi" 
              placeholder="摆放位置" clearable  :readonly="ro.baifangweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="摆放位置" prop="baifangweizhi">
              <el-input v-model="ruleForm.baifangweizhi" 
                placeholder="摆放位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chanpinleixing = true;
          ...
          if(o=='gonghuochangjia'){
            this.ruleForm.gonghuochangjia = obj[o];
	    this.ro.gonghuochangjia = true;
            continue;
          }
	    ...
	    this.ro.chanpinshuliang = true;
          ...
          if(o=='chanpinjinjia'){
            this.ruleForm.chanpinjinjia = obj[o];
	    this.ro.chanpinjinjia = true;
            continue;
          }
          if(o=='beizhu'){
	    ...
	    this.ro.beizhu = true;
          ...
          if(o=='baifangweizhi'){
            this.ruleForm.baifangweizhi = obj[o];
	    this.ro.baifangweizhi = true;
            continue;
          }
          if(o=='rukuriqi'){
    ...
    onSubmit() {
      ...
      if(obj!=null) {
	      obj.chanpinshuliang = parseFloat(obj.chanpinshuliang) + parseFloat(this.ruleForm.chanpinshuliang)
	      this.$http({
		  url: `${table}/update`,
		  method: "post",
		  data: obj
